...
//            'status' => 'required',
        ...
        $user -> role = (!is_null($request -> role) ? $request->role : "employee");
        ...
        $user -> job_type = (!is_null($request -> job_type) ? $request->job_type : "employee");
      //  $user -> country = $request -> country;
        $user -> city = (!is_null($request -> city) ? $request->city : "");
        $user -> age = (!is_null($request -> age) ? $request->age : "19");
       ...
       $employment_detail = EmployeeDetail::create(
        ...
        $skills = Skill::create(
        ['employee_id' => $user->id,
        'skill_name1' => $request->skill_1,
        'skill_name2' => $request->skill_2,
        'skill_name3' => $request->skill_3
        ]);
