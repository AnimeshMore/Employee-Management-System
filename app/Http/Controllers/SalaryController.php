...
class SalaryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $salary = new Salary();
        $salary -> employee_id = $request -> salary;
        $salary -> salary_amount = $request -> salary_amount;
        $salary -> salary_type = $request -> salary_type;
        $salary -> allowance_amount = $request -> medical_allowance;
    ...
    public function paymentstore(Request $request)
    {
      ...
      //  $paymentsalary -> user_id = $request -> user_id;
        ...
        $transaction = Transaction::create(
            ...
            'user_id' => $request->employee_id,             //newly added
