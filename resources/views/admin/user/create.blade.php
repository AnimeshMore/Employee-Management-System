            ...
            <!--    <li>
                ...
                <li>
                  <a href="#step-3">
                    ...
                    <span class="step_descr">
                                      Step 3<br />
                                      <small>Step 3 Salary Detils</small>
                                  </span>
                  </a>
                </li>
              </ul>
                        ...
                        {{-- <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"> --}}
                          ...
                          <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="fname" name="fname"  class="form-control col-md-7 col-xs-12" placeholder="Enter First Name" required>
                            </div>
                         
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="lname" name="lname"  class="form-control col-md-7 col-xs-12" placeholder="Enter Last Name" required>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input id="email" name="email" class="form-control col-md-7 col-xs-12" type="text" placeholder="Enter E-mail" required>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <div class="input-group">
                          ...
                          <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input id="phone" name="phone" class=" form-control col-md-7 col-xs-12"  type="text" placeholder="Enter Phone Number 1" required>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <textarea id="address" name="address" class=" form-control col-md-7 col-xs-12" cols="5" rows="2" placeholder="Enter Address" required></textarea>
                            </div>
                        ...
                        {{-- <form class="form-horizontal form-label-left"> --}}
                          <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <input id="passport" name="passport" class=" form-control col-md-7 col-xs-12"  type="text" placeholder="Enter Passport Number" autocomplete="off" required>
                            </div>
                          ...
                          <div class="form-group">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <input id="designation" name="designation" class=" form-control col-md-7 col-xs-12"  type="text" placeholder="Enter Designation" required>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <input id="username" name="username" class=" form-control col-md-7 col-xs-12"  type="text" placeholder="Enter Username" required>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <input id="password" name="password" class=" form-control col-md-7 col-xs-12"  type="text" placeholder="Enter Password" required>
                            </div>
                          </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <select name="employee_type" id="employee_type" class="form-control">
                                ...
                                <option value="intan"> Internship</option>
                              </select>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <input id="office_email" name="office_email" class=" form-control col-md-7 col-xs-12"  type="email" placeholder="Enter Office E-mail" autocomplete="off" required>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <input id="emergency_number" name="emergency_number" class=" form-control col-md-7 col-xs-12"  type="phone" placeholder="Enter Emergency Number" autocomplete="off" required>
                            </div>
                          </div>
                    ...
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        <br />
                          ...
                          <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="bank_name" name="bank_name"  class="form-control col-md-7 col-xs-12" placeholder="Enter Bank Name" required>
                            </div>
                         
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="account_number" name="account_number"  class="form-control col-md-7 col-xs-12" placeholder="Enter Account Number" required>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <input type="text" id="salary_amount" name="salary_amount"  class="form-control col-md-7 col-xs-12" placeholder=" Salary Amount" required>
                            </div>

                            <div class="col-md-4 col-sm-6 col-xs-12">
                              <input id="medical_allowance" name="medical_allowance" class=" form-control col-md-7 col-xs-12" type="text" placeholder="Medical Allowance" required>
                          </div>
                          </div>
