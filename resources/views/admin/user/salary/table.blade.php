...
@endphp
    ...
    <div class="page-wrapper">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2 btn-dark btn-sm btn-round ">Total Paid Salary  <i class="fa"></i> <b>
        ...
        <div class="col-sm-2 btn-dark btn-sm btn-round pull-right">Net Salary  <i class="fa"></i> <b>{{$salary_amount->salary_amount}}</b></div>
                        ...
                        <tbody>
                          ...
                          @foreach($employee_salary as $transaction)
                              <tr>
                                  ...
                                  <td><i class="fa"></i> {{$transaction ->amount }}</td>
                                  <td><i class="fa"></i> {{$transaction ->salary_amount }}</td>
                                  <td><i class="fa"></i> @if ($originalBalance == 0) 
                      ...
                      <tbody>
                        @foreach($employee_overtime_salary as $transaction)
                            <tr>
                                ...
                                <td>{{$loop -> index+1 }}</td>
                                <td><i class="fa"></i> {{$transaction ->overtime_amount }}</td>
                      ...
                      <tbody>
                        @foreach($employee_bonus_salary as $transaction)
                            <tr>
                                ...
                                <td>{{$loop -> index+1 }}</td>
                                <td><i class="fa"></i> {{$transaction ->bonus_amount }}</td>
