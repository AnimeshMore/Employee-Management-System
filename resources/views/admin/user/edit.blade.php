    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2><b>Update</b> Employee Information<small> Portal</small></h2>
          ...
          <div  class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <input value="{{ $user->roll_no }}" class=" form-control col-md-7 col-xs-12"  type="text" placeholder="ID" disabled>
                  </div>
                  <div class="col-md-8 col-sm-6 col-xs-12">
