              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                        ...
                        <dl class="row employeedetails">
                            ...
                            <dd class="col-sm-7" name="employee_salary" id="employee_salary"><i class="fa"></i> @isset($paidSalary)
                            ...
                            <dd class="col-sm-7" name="advance" id="advance"><i class="fa"></i> {{$advancePayment->total}} </dd>
                            {{-- <div class="clearfix"></div> --}}
                            <hr>
                            <dt class="col-sm-5">Overtime Payment:</dt>
                            <dd class="col-sm-7" name="overtime" id="overtime"><i class="fa"></i> {{$overtimePayment->overtime}} </dd>
                            {{-- <div class="clearfix"></div> --}}
                            <hr>
                            <dt class="col-sm-5">Bonus Payment:</dt>
                              <dd class="col-sm-7" name="bonus" id="bonus"><i class="fa"></i> {{$bonusPayment->bonus}}  </dd>
                        </dl>

                        <hr>
                <div class="x_panel-footer">
                    <dt class="col-sm-5">Total:</dt>
                    <dd class="col-sm-7" name="total" id="total"><i class="fa"></i> </dd>
                </div>
                <hr>
                <hr>
                <div class="x_panel-footer">
                    <dt class="col-sm-5">Grand Total:</dt>
                    <dd class="col-sm-7" name="total" id="grand-total"><i class="fa"></i> </dd>
                </div>
                <hr><hr>
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form action="{{route('paysalary.store')}}" method="post" class="form-horizontal advance-pay">
                    ...
                    <div class="form-group">
                    <div class="col-md-12">
                      <b class="btn-round btn-info btn-sm"> Monthly Salary  <i class="fa"></i> {{$monthlySalary->salary}}</b> 
                    </div>
                    </div>
                        <div class="form-group">
                            <div class="col-sm-6">
                ...
                <div class="x_content collapse">
                    ...
                    <form action="{{route('managesalary.makeadvance')}}" method="post" class="form-horizontal advance-pay">
                        ...
                        <input type="hidden" name="employee_id" value="{{$user->id}}">
                            <div class="form-group">
                                <div class="col-sm-6">
                                    <input type="text" name="date" id="bonus_date" class="form-control">
                                </div>
                                <div class="col-sm-6">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content collapse">
                      ...
                      <form action="{{route('managesalary.overtimepayment')}}" method="post" class="form-horizontal overtime-pay">
                          ...
                          <hr>
                          <button type="submit" class="btn btn-round btn-danger"><i class="fa fa-money"></i> Overtime Payment </button>
                      </form>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content collapse">
                      ...
                      <form action="{{route('managesalary.bonuspayment')}}" method="post" class="form-horizontal bonus-pay">
                          ...
                          <hr>
                          <button type="submit" class="btn btn-round btn-primary"><i class="fa fa-money"></i> Bonus Payment </button>
                      </form>
                        ...
                        <tbody>
                          @foreach($transactions as $transaction)
                              <tr>
                                  ...
                                  <td><i class="fa"></i> {{$transaction ->paid_amount }}</td>
                                  <td><i class="fa"></i> {{$transaction ->salary_amount }}</td>
